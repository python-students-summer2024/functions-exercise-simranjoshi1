...
def print_question(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        print_statement = "You rolled a {0} and a {1}... What is the sum of {0} and {1}?".format(die_1_value, die_2_value)
    else:
        print_statement = "You rolled a {0} and a {1}... What is the difference between {0} and {1}?".format(die_1_value, die_2_value)
...
def input_answer():
    ...
    if len(answer) == 0:
        return -1 
    if answer[0] == "-" and answer[1:].isdigit():
        return int(answer)
    elif answer.isdigit():
        return int(answer)
    else:
...
def print_correct_answer(die_1_value, die_2_value, question_type):
    ...
    # complete this function below here
    if question_type == "sum":
        addition = die_1_value + die_2_value
        printstatement = ("No! The sum of {} and {} is "+str(addition)+"!").format(die_1_value, die_2_value)
        print(printstatement)
    if question_type == "difference":
        difference = abs(die_1_value - die_2_value)
        printstatement = ("No! The difference between {} and {} is "+str(difference)+"!").format(die_1_value, die_2_value)
        print(printstatement)
